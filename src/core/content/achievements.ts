...
export interface AchievementDef {
  ...
  /** Id kosmetiky udělené při odemčení (vizuál jako odměna za HRANÍ, ne za peníze). */
...
export const ACHIEVEMENTS: readonly AchievementDef[] = [
  ...
  { id: 'thumb_of_steel', name: 'Thumb of Steel', description: 'Swipe 1,000 posts in a run. (Unlocks the 👑 Golden Thumb skin.)', icon: '💪', condition: { kind: 'swipes', value: 1000 }, reward: 'golden_thumb' },
  { id: 'two_screens', name: 'Two Screens Are Better', description: 'Own a second phone.', icon: '📱', condition: { kind: 'phones', value: 2 } },
  { id: 'phone_farmer', name: 'Phone Farmer', description: 'Run the maximum 10 phones at once.', icon: '🚜', condition: { kind: 'phones', value: 10 } },
  { id: 'bot_farm', name: 'Industrial Doomscroll', description: 'Swipe 10,000 posts in a single run.', icon: '🖥️', condition: { kind: 'swipes', value: 10000 } },
  ...
  { id: 'touched_grass', name: 'Touched Grass (briefly)', description: 'Prestige for the first time. (Unlocks the 🌱 Touched Grass skin.)', icon: '🌱', condition: { kind: 'prestiges', value: 1 }, reward: 'grass_filter' },
